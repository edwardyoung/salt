...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "spunk_idx1" do |spunk_idx1|
    spunk_idx1.vm.box = "bento/debian-9.5"
    spunk_idx1.vm.hostname = "spl-idx1"
    spunk_idx1.vm.network "private_network", ip: "192.168.50.9"
  end

  config.vm.define "spunk_idx2" do |spunk_idx2|
    spunk_idx2.vm.box = "bento/debian-9.5"
    spunk_idx2.vm.hostname = "spl-idx2"
    spunk_idx2.vm.network "private_network", ip: "192.168.50.10"
  end

  config.vm.define "spunk_idx3" do |spunk_idx3|
    spunk_idx3.vm.box = "bento/debian-9.5"
    spunk_idx3.vm.hostname = "spl-idx3"
    spunk_idx3.vm.network "private_network", ip: "192.168.50.11"
  end

  config.vm.define "spunk_idx4" do |spunk_idx4|
    spunk_idx4.vm.box = "bento/debian-9.5"
    spunk_idx4.vm.hostname = "spl-idx4"
